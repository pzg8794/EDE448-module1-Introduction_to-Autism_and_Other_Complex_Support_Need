...
The goal is to create a classroom where students with autism and other complex support needs can communicate, make choices, experience joy, demonstrate competence, belong, and be believed. Understanding developmental difference responsibly requires more than naming a condition. It requires staying curious about the person, examining the power inside our sources, collecting richer evidence, and changing the environment before deciding that the learner is the problem.
